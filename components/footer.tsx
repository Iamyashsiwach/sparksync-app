          ...
          <div>
            ...
            <ul className="space-y-3 text-sm md:text-base text-gray-200">
              ...
              <li className="flex items-start">
                ...
                <span>Office Address: Cabin No 4, 3rd Floor, Oahfeo Coworking Space, Sector 45 Gurgaon 122003</span>
              </li>
              {/* Phone with icon */}
              <li className="flex items-start">
                <svg className="h-5 w-5 md:h-6 md:w-6 mr-2 text-teal flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="tel:+918950803350" className="text-gray-200 hover:text-teal-400">Mobile No: +91 8950803350</a>
              </li>
              {/* Email with icon */}
              <li className="flex items-start">
                <svg className="h-5 w-5 md:h-6 md:w-6 mr-2 text-teal flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
